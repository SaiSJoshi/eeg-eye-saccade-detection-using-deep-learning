...
# layout=[[sg.Text('EEG Saccade Detecction')],
#         [sg.Button("Load")]]

# window=sg.Window(title="IDL_Project", layout=layout, margins=(500,350))

# while True:
#     event, values = window.read()


#     if event == "Load" or event == sg.WIN_CLOSED:
#         break
...
if __name__ == '__main__':
    ...
    window = sg.Window('Demo Application - Embedding Matplotlib In PySimpleGUI',
                       layout,margins=(500,350), finalize=True)
